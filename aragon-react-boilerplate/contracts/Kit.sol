...
import "./CollectiveWalletApp.sol";
...
//		CounterApp app = CounterApp(dao.newAppInstance(appId, latestVersionAppBase(appId)));
		CollectiveWalletApp app = CollectiveWalletApp(dao.newAppInstance(appId, latestVersionAppBase(appId)));
		app.initialize();
		...
		acl.createPermission(ANY_ENTITY, app, app.INCREMENT_ROLE(), voting);
